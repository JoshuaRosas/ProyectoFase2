...
public class Test {
	...
	public static void main(String[] args) throws ItemDuplicated {
		...
		historialCotizacion c = new historialCotizacion();
		
		//Menu para los clientes
		System.out.println("Bienvenido a CasaCambista");
		System.out.println("1. Crear cuenta ");
		System.out.println("2. Iniciar sesion ");
		System.out.println("3. Ingresar sin cuenta ");
		System.out.println("4. Mostrar casas de cambio ");
		...
		case 1:
			...
			System.out.println("2. Añadir casa de cambio");
			int op2 = opcion.nextInt();
			if(op2 == 1) {
				b.crearCuenta();
			} else if(op2 == 2) {
				a.agregarCasa();
		...
		System.out.println("1. Agregar casa de cambio ");
		System.out.println("2. Eliminar casa de cambio ");
		System.out.println("3. Historial sin cuentas ");
	...
	//	System.out.println("Antes\n"+userna);
		...
		long z = Long.parseLong("12345678945");
		//////////////////////////////////////////////////////////////////////////////
		...
		IconoDeFrameMenu.setIcon(new ImageIcon("C:\\Users\\Joshua\\Downloads\\morali.png"));
		...
		iconoDeCabeceraDeRegistro1.setIcon(new ImageIcon("C:\\Users\\Joshua\\Downloads\\morali_4.png"));
